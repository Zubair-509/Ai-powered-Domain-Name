        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-6">
            ...
            <nav className="hidden sm:flex space-x-8">
              ...
              <Link href="/about" className="text-primary font-medium transition-colors">About</Link>
            </nav>
          </div>
        </div>
      </header>
      ...
      <section className="py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="bg-gradient-to-r from-primary to-primary-dark rounded-2xl p-12 text-white">
            <h3 className="text-3xl font-bold mb-4">Ready to Find Your Million-Dollar Domain?</h3>
